...
class Brand(models.Model):
    ...
    image = models.ImageField(upload_to='brands/', blank=True, null=True, verbose_name='Brand Image')
...
class ProductGroup(models.Model):
    ...
    image = models.ImageField(upload_to='groups/', blank=True, null=True, verbose_name='Group Image')
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Supplier(models.Model):
    ...
    image = models.ImageField(upload_to='suppliers/', blank=True, null=True, verbose_name='Supplier Image')
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Product(models.Model):
    ...
    @property
    def balance(self):
        """Valor total en stock: precio unitario × stock. Calculado, no persistido."""
        price = self.unit_price or Decimal('0')
        return (price * self.stock).quantize(Decimal('0.01'), rounding=ROUND_HALF_UP)
...
class Customer(models.Model):
    ...
    dni = models.CharField(max_length=13, unique= True, validators= [validate_cedula_ec])
